 ...
 * @Last Modified time: 2017-11-13 17:32:08
...
var config = {
    ...
    output: {
        path: __dirname + '/dist/',
        publicPath: WEBPACK_ENV === 'online' ? '//dmall-s.huanliu.org/admin/dist/' : '/dist/',
        filename: 'js/[name].js'
    },
    resolve: {
        alias: {
...
if (WEBPACK_ENV === 'dev') {
    config.entry.app.push('webpack-dev-server/client?http://localhost:8087');
}
